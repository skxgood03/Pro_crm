...
class ClassList(models.Model):
    ...
    class_teacher = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',on_delete=models.CASCADE,
                                      limit_choices_to={'depart__title': '教育部'},null=True)


    tech_teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo', related_name='teach_classes', blank=True,
                                           limit_choices_to = {'depart__title__in': ['Linux教学部', 'Python教学部']},null=True)
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultant',
                                   ...
                                   limit_choices_to={'depart__title': '运营部'},on_delete=models.CASCADE)
    education_choices = (
        (1, '重点大学'),
        (2, '普通本科'),
        (3, '独立院校'),
